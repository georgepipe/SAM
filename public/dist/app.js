...
function pagination() {
  ...
  if (tableA || tableB) {
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              clickedButton = e.target.closest('.pgBtn');
              if (clickedButton) {
                _context.next = 3;
                break;
              }
    ...
    var Pagination = {
      build: function build(page, totalPages) {
        ...
        var uniquePages = _toConsumableArray(new Map(pages.map(function (item) {
      ...
      render: function render(paginationArray) {
        ...
        html += "<a href=\"#\" class=\"pgBtn pgBtnArrow rounded-r-md hover:bg-gray-50 focus:z-20 focus:outline-offset-0\" data-delta=\"1\">".concat(ICONS.forwardArrow, "<span class=\"sr-only\">Next</span></a>");
        // console.log(html);
        return html;
      }
    };
...
/* harmony import */ var _pagination_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pagination.js */ "./src/js/pagination.js");
