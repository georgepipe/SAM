...
function initWorkOrders() {
  ...
  //click handler
  function handlePaginationClick(_x) {
    return _handlePaginationClick.apply(this, arguments);
  } //fetch logic
  function _handlePaginationClick() {
    _handlePaginationClick = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
  ...
  function fetchWorkorders(_x2) {
    return _fetchWorkorders.apply(this, arguments);
  } //render table
  function _fetchWorkorders() {
    _fetchWorkorders = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url) {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
  ...
  function createActionLink(href, svg) {
